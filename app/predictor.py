...
selected_features = joblib.load("../models/models_dump_for_Registry/selected_features.joblib")
scaler = joblib.load("../models/models_dump_for_Registry/scaler.joblib")
